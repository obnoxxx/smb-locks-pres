...
\section<presentation>[SMB\_CREATE]{The SMB\_CREATE call}
\begin{frame}{The SMB\_CREATE call}
    \pause
    \begin{itemize}[<+->]
        \item create disposition:
        \pause
        \begin{itemize}[<+->]
        ...
        \end{itemize}
        \item desired access
        \item share access: share modes
        \item oplocks/leases
    \end{itemize}
\end{frame}

\begin{frame}{create docs}
\begin{block}{MS protocol spec SMB\_CREATE}
